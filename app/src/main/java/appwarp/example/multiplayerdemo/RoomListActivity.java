...
public class RoomListActivity extends Activity implements ZoneRequestListener {
    ...
    public void onStart() {
        ...
        theClient.getRoomInRange(1, 2);// trying to get room with at least one user
    }
    ...
    public void onJoinNewRoomClicked(View view) {
        ...
        theClient.createRoom("" + System.currentTimeMillis(), Utils.getMyUserName(), 2, properties);
    }
    ...
    private void goToGameScreen(String roomId) {
        Intent intent = new Intent(this, SnakeAndLaddersActivity.class);
